...
$ModelsTable= @(
@{ Model ="HP EliteBook 840 G5"; Platform = "83B2"}
@{ Model ="HP EliteBook 840 G8 Notebook PC"; Platform = "880D"}
@{ Model ="HP EliteBook 845 G7 Notebook PC"; Platform = "8760"}
@{ Model ="HP EliteBook 840 G6"; Platform = "8549"}
...
@{ Model ="HP ZBook 15 G6"; Platform = "860F"}
...
@{ Model ="HP ZBook Firefly 15 G7 Mobile Workstation"; Platform = "8724"}
...
@{ Model ="HP EliteBook x360 1030 G8 Notebook PC"; Platform = "8720"}
@{ Model ="HP ZBook Firefly 14 G7 Mobile Workstation"; Platform = "8724"}
...
@{ Model ="HP EliteBook x360 1030 G7 Notebook PC"; Platform = "876D"}
...
$ReferenceFileLocation = "\\src\src$\Packages\HP ImageAssistant\ReferenceFiles"
