...
Please note, you will get A LOT of data returned in the Run Script Dialog.  Feel free to remove some of the Write-Outputs.  This was orginally written for other deployment methods.
#>
